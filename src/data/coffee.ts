...
export const coffeeTask = [
  ...
  'В нём чего-то не хватает. Вернее — кое-кто однажды принесла сюда то, что превратило обычный день в особенный.',
  'Выбери, что это было.',
]
...
export const coffeeItems: CoffeeItem[] = [
  ...
  { id: 'waffles', icon: '🧇', name: 'Вафли', correct: true },
  {
    ...
    name: 'Записка',
    correct: false,
    wrongMsg: 'Записка? Хм, в тот день её вроде не было.',
  },
  {
    id: 'mouse',
    icon: '🖱️',
...
export const coffeeFound = [
  'Кажется, кое-кто однажды пришёл ко мне на работу не с пустыми руками.',
  'После этого день стал намного приятнее.',
]
